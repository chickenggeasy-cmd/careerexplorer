...
| ฟีเจอร์ | คำอธิบาย |
| --- | --- |
| 🗂️ สำรวจสายงาน | 14 สายงานหลัก รวม **400+ อาชีพ** พร้อมเงินเดือน การศึกษา ทักษะ ข้อดี-ข้อเสีย |
...
- อัตราแปลง USD/THB ดึงสดจาก **Frankfurter API** (`https://api.frankfurter.dev/v1/latest?from=USD&to=THB`) ทุกครั้งที่โหลดหน้าเว็บ และรีเฟรชซ้ำทุก 1 ชั่วโมงถ้าเปิดหน้าค้างไว้ ถ้า API ล่มจะ fallback ไปใช้ `GLOBAL_EXPLORER.usdThbRate` (ค่าสำรอง = 35) แทนอัตโนมัติ

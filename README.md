...
| 🌍 **Global Career Map** *(ของใหม่ ไม่มีใน README เดิม)* | หน้า "สำรวจสายงาน" มี 2 โหมด: แผนที่โลกแบบ SVG ให้เลือก 1 ใน 6 ทวีป × 3 ประเทศเด่นต่อทวีป แล้วแปลงฐานเงินเดือน (บาท) เป็นค่าประมาณของประเทศนั้น ด้วย "ตัวคูณตลาดแรงงาน" คงที่ที่ตั้งไว้ในโค้ด (ไม่ใช่อัตราแลกเปลี่ยนจริงแบบ real-time) |
